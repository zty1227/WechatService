...
public class TemplateMessageController extends GenericController {
    ...
    @RequestMapping(value = "setTemplateMessageTest")
    public void setTemplateMessageTest(HttpServletRequest request,
                                   HttpServletResponse response){
        WxMpTemplateMessage wxMpTemplateMessage = new WxMpTemplateMessage();
        wxMpTemplateMessage.setToUser(request.getParameter("openid"));
        wxMpTemplateMessage.setTemplateId("N4NLOvMMLbffRVODavV9vYepZFaMbmm1ajjxkVXaryM");
        wxMpTemplateMessage.setUrl(request.getParameter("url"));
        WxMpTemplateData testData = new WxMpTemplateData("test", "test", TEMPLATE_FRONT_COLOR);
